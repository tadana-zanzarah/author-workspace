...
-- ===========================================================================
-- Block G: unknown module key (not on the Phase-1 allowlist) is rejected.
-- ===========================================================================
do $$
declare
  proj uuid:='f2000000-0000-4000-8000-000000000001';
...
begin
  ...
  r:=public.update_project_location_module_selection(proj,pl_id,rev,jsonb_build_object('shown',jsonb_build_array('economy')));
  ...
  payload:=jsonb_build_object(
    ...
    'locations',jsonb_build_array(
      jsonb_build_object(
        ...
        'module_selection',jsonb_build_object('shown',jsonb_build_array('economy','appearanceAtmosphere',42),'hidden','not-an-array','extra','key')
      ),
      jsonb_build_object(
