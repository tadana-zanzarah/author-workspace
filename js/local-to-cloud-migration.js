...
function buildLocalToCloudMigrationPreview({
  localProject,sourceProjectId,targetProjectId,targetProjectRevision,targetCloudState={},existingGlobalCharacters=[],characterDecisions={},structuralLinkDecisions={}
}={}){
