...
if(!await page.evaluate(()=>document.getElementById("localCloudMigrationModal").scrollWidth<=document.documentElement.clientWidth))throw new Error("Migration wizard overflows at 390px");
