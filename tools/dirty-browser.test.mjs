...
// T1 rich-text editor: #fullSceneText textarea replaced by a ProseMirror mount
// (#fullSceneTextEditor); dirty-tracking now reads the editor's doc JSON (see
// js/app.js's textModal dirty tracker) instead of a textarea value.
await page.evaluate(()=>openSceneText("scene-a"));await page.waitForSelector("#fullSceneTextEditor .ProseMirror");
